...
-- 4. No need to check for blanks as this is a field with data type int. 


--  5.b–d. Range [101, 2199] can be seen from previous select statement. Duplicates are expected(multiple reports per reporting district). 
-- View counts to validate there are no invalid observations. 
