...
-- Each area code and area spelling have the same count.

-- B.3. AREA_NAME stays a string

-- A.4. No blanks or empty spaces.  ^^
...
-- A.5.c. The range can be viewed in the above select statement. Area codes 1-21, and their corresponding LAPD divisions.
-- A.5.c. Any invalid observations would have been shown in the above select statment, as it includes each observation and its count. 
